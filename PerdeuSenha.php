...
?> <br><br>	<?php
	if (empty($_POST['cpf']) || empty($_POST['email'])){
		...
		if (!$validarCpf->valida()){
			?> <div class="alert alert-error"> <font size="3px" color="red"> CPF não confere, tente novamente! </font> </div> <?php
		} else if (!$retEmail) {
			?> <div class="alert alert-error"> <font size="3px" color="red"> Email não confere, tente novamente! </font> </div> <?php
		} else {
...
?>
			...
			<h2>Recupere a sua senha aqui!</h2><br>
				...
				<div class="control-group">
					...
					<input type="text" name="cpf" placeholder="Digite seu cpf" id="cpf" class="input-xlarge" required="required" maxlength="14" size="8" onKeyPress="return digitos(event, this);" onKeyUp="Mascara('CPF',this,event);"/>
		        </div><br>
		        <div class="control-group">
					<span><img alt="" src="fotos/email.jpg"> </span>
					<input type="email" name="email" placeholder="Informe seu Email Cadastrado" class="input-xxlarge" maxlength="36" required="required"/>
		        </div><br>
...
<div align="center"> <a href="Login.php">Voltar ao Login</a> </div>
